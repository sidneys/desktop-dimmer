...
module.exports = function create (opts) {
  ...
  function appReady () {
    ...
    // Taskbar Multi-Position Support
    switch (process.platform) {
      ...
      case 'darwin':
        ...
        break
      // Windows (top/bottom/left/right taskbar)
      case 'win32':
        var trayBounds = menubar.tray.getBounds();
        var traySide = undefined;
    ...
    function showWindow (trayPos) {
      ...
      // Taskbar Multi-Position Support
      // center align window and tray vertically
      if (opts.windowPosition.substr(0, 6) === 'bottom') {
